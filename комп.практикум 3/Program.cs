...
namespace комп.практикум_3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    omas[i] = int.Parse(Console.ReadLine());
            //}
            //int max = omas[0]; int index1 = 0;
            //int min = omas[0]; int index2 = 0;
            //for (int i = 1; i < omas.Length; i++)
            //{
            //    if (omas[i] > max)
            //    {
